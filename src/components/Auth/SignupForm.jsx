...
const SignupForm = ({ onToggleMode, onSuccess }) => {
  ...
  return (
    <div className="card" style={{ maxWidth: '400px', width: '100%', margin: '0 auto', backgroundColor: '#ffffff', color: '#000000' }}>
      <h2 style={{ fontSize: 'var(--text-xl)', marginBottom: 'var(--space-6)', textAlign: 'center', color: '#000000' }}>Create Account</h2>
      ...
      <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-4)' }}>
        <div>
          <label style={{ display: 'block', marginBottom: '4px', fontSize: 'var(--text-sm)', fontWeight: 500, color: '#000000' }}>Full Name</label>
          <input 
            type="text" 
            value={name} 
        ...
        <div>
          <label style={{ display: 'block', marginBottom: '4px', fontSize: 'var(--text-sm)', fontWeight: 500, color: '#000000' }}>Account Type</label>
          <select 
            value={role} 
      ...
      <Button type="button" onClick={handleGoogleSignup} isLoading={loading} style={{ width: '100%', backgroundColor: '#ffffff', color: '#374151', border: '1px solid #d1d5db', marginBottom: 'var(--space-4)' }}>
